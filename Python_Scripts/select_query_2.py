...
rating_df = pd.DataFrame(list(session.execute(prepared_query_2, movie_df.movieid)))
...
tag_df = pd.DataFrame(list(session.execute(prepared_query_3, movie_df.movieid)))
